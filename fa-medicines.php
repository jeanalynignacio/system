    ...
    <div class="main--content">
        ...
        <div class="card--container">
            <h3 class="main--title"> Type of Financial Assistance 
                <ul class = "drop"> 
                <li>
                    <a href = "#" onclick="medicines()"> Medicines <i class="fa-solid fa-caret-down"></i> </a>
                    <ul class = "dropdown">
...
function search() {
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        var transactionTypeCell = row.cells[5];
        var assistanceTypeCell = row.cells[6];
