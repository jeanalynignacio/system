                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th> Types Dialysis Assistance: </th>
                            <th> Status: </th>
                            <th> Action: </th>
                            <th> History: </th>
                        </tr>
...
$sql = "SELECT t.Date, t.transaction_time, b.Beneficiary_Id, b.Lastname, b.Firstname, b.CityMunicipality, t.Given_Sched, t.TransactionType, m.DialysisAssistanceType, t.Status, t.Given_Time
        FROM dialysis m
...
if ($row["Given_Time"] !== NULL) {
    ...
    echo "<tr>
            ...
            <td>" . $row["DialysisAssistanceType"] . " </td>
            <td>" . $row["Status"] . " </td>
            <td>".
            "<form method='post' action='editformdialysis.php'>" .
...
function editRecord(beneficiaryId) {
    ...
    form.method = 'post';
    form.action = 'editformdialysis.php'; // Corrected action to 'edit-form.php'
