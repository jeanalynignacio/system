...
<body>
    <div class="sidebar">
        ...
        <ul class="menu" style="margin-top: 15px; margin-left: -8px;">
            ...
            <li><a href="#" onclick="dialysis()" style="font-size:14px;height:10px; ">
            <i class="fa-solid fa-file-medical" style="margin-right:6px; margin-left:5px;"></i><span>Dialysis</span></a></li>
            <?php if ($role === 'Admin'): ?>
