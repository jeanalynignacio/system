    ...
    <div class="main--content">
        ...
        <div class="card--container">
            <h3 class="main--title"> Type of Financial Assistance
                <ul class = "drop"> 
                <li>
                    <a href = "#"onclick="burial()"> Burial <i class="fa-solid fa-caret-down"></i> </a>
                    <ul class = "dropdown">
        ...
        WHERE AssistanceType ='Financial Assistance-Burial' 
        AND branch='$branch'";
...
?>
        ...
        <div class="tabular--wrapper">
            <h3 class="main--title"> Financial Assistance - Burial Data </h3>
...
if ($role === 'Accounting Staff'){
    ...
    where t.Status != 'Done' && t.Status='For Payout' && f.branch='$branch' && FA_type= 'Burial'
           ORDER BY t.Date ASC, t.transaction_time ASC";
    }
    else{
$sql = "SELECT t.Date, t.transaction_time, b.Beneficiary_Id, b.Lastname, b.Firstname, b.CityMunicipality, t.Given_Sched, t.TransactionType,  t.Status ,f.Amount,t.Given_Time 
        FROM financialassistance f 
        INNER JOIN beneficiary b ON b.Beneficiary_Id = f.Beneficiary_ID
        INNER JOIN transaction t ON t.Beneficiary_Id = f.Beneficiary_ID
