  ...
  <body>
    <div class="container">
      ...
      <?php 
               ...
               $query = mysqli_query($con, "SELECT t.Date, t.transaction_time, b.Beneficiary_Id, b.Lastname, b.Firstname,b.CityMunicipality, t.TransactionType,t.Given_Sched, m.MedicineType, t.Status FROM medicines m INNER JOIN beneficiary b ON b.Beneficiary_Id = m.Beneficiary_ID INNER JOIN transaction t ON t.Beneficiary_Id = m.Beneficiary_ID WHERE m.Beneficiary_ID='$beneID'" );
               ...
               while($result = mysqli_fetch_assoc($query)){
                   ...
                   $res_FA_Type = $result['MedicineType'];
...
<div class="input-box">
            <span class="details"> Types of Medicines </span>
            <input type="text" required value="<?php echo $record['MedicineType']; ?>" name="MedicineType"/>
          </div>
